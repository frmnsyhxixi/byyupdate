...
module.exports = welcome = async (devil, anu) => {
		...
		try {
            ...
            devil.sendMessage(anu.jid, 'Halo! Terima Kasih sudah Mengundangku, Jika ingin Menggunakan Bot Ketik ${prefix}menu', 'conversation')
            }
             if (anu.action == 'add' && !mem.includes(devil.user.jid)) {
             if (!welkom.includes(anu.jid)) return
                ...
                teks = `Halo Pendatang baru\n${anu_user} \nSemoga Betah And Following Rules Group`
